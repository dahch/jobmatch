    ...
    <div className="card overflow-hidden">
      ...
      {expanded && (
        <div className="p-5 space-y-5 animate-fade-in">
          {changes.length > 0 && (
            <div>
              <h4 className="text-[11px] font-semibold text-surface-400 uppercase tracking-wide mb-2">
                {t("cv_builder.changes_made")}
              </h4>
          ...
          {keywords.length > 0 && (
            <div>
              <h4 className="text-[11px] font-semibold text-surface-400 uppercase tracking-wide mb-2">
                {t("cv_builder.ats_keywords")}
              </h4>
              <div className="flex flex-wrap gap-1">
                {keywords.map((kw) => (
                  <span
                    key={kw}
                    className="text-[11px] bg-emerald-50 text-emerald-600 px-2 py-0.5 rounded border border-emerald-100/60 font-medium"
                  >
                    {kw}
                  </span>
                ))}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h4 className="text-[11px] font-semibold text-surface-400 uppercase tracking-wide mb-1.5">
                {t("cv_builder.original_summary")}
              </h4>
              <p className="text-sm text-surface-600 bg-surface-50 p-3 rounded-lg border border-surface-100 leading-relaxed">
                {original.summary || "—"}
              </p>
            </div>
            <div>
              <h4 className="text-[11px] font-semibold text-surface-400 uppercase tracking-wide mb-1.5">
                {t("cv_builder.optimized_summary")}
              </h4>
              <p className="text-sm text-surface-600 bg-emerald-50/50 p-3 rounded-lg border border-emerald-100/40 leading-relaxed">
                {optimized.summary}
              </p>
            </div>
          </div>
